...
from examples.hifi.EnvironmentPrediction.Predictions.SensorMeasurements.utils import *
from examples.hifi.EnvironmentPrediction.Predictions.SensorMeasurements.GroundSeg import *

# loop through the training sequences, save each set of data separately
KITTI_DIR = 'examples/hifi/EnvironmentPrediction/Data/KITTI/'
OUTPUT_DIR = 'examples/hifi/EnvironmentPrediction/Data/SensorMeasurements/'
