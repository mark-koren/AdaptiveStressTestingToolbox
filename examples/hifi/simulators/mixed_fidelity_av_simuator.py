...
class MixedFidelityAVSimulator(ASTSimulator):  # Define the class
    """Example simulator wrapper for a scenario of an AV approaching a crosswalk where some pedestrians are crossing.
    ...
    def __init__(self,
        ...
        self.simulator = simulator_cls(num_peds=num_peds, **simulator_args)
    ...
    def reset(self, s_0):
        ...
        super(MixedFidelityAVSimulator, self).reset(s_0=s_0)
    ...
    def is_terminal(self):
        return  self.simulator._is_terminal
    ...
    def clone_state(self):
        ...
        """
        simulator_clone_state = getattr(self.simulator, "clone_state", None)
        if callable(simulator_clone_state):
            return self.simulator.clone_state()
    ...
    def restore_state(self, in_simulator_state):
        ...
        """
        simulator_restore_state = getattr(self.simulator, "restore_state", None)
        if callable(simulator_restore_state):
            return self.simulator.restore_state(in_simulator_state)
