...
from examples.hifi.spaces.perception_av_spaces import PerceptionAVSpaces
        ...
        with tf.Session(config=config) as sess:
            with tf.variable_scope('AST', reuse=tf.AUTO_REUSE):
                ...
                with LocalTFRunner(
                    ...
                    spaces = PerceptionAVSpaces(**spaces_args)
                    ...
                    if save_expert_trajectory:
                        if ('snapshot_mode' in run_experiment_args.keys() and
                            ...
                            last_iter_filename = os.path.join(run_experiment_args['log_dir'],
                                                            ...
                                                            '.pkl')
                        load_convert_and_save_drl_expert_trajectory(last_iter_filename=last_iter_filename,
